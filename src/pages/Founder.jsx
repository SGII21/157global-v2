    ...
    <PageLayout>
      <div className="pt-8 md:pt-10">
        ...
        <p className="mt-8 font-serif text-[22px] italic text-ink">
          Skip Glass built <span style={{ whiteSpace: 'nowrap' }}>157Global</span> from more than thirty years of working inside difficult situations, not observing them.
        </p>
        ...
        <p className={`${bodyClass} mt-6`}>
          This foundation is why <span style={{ whiteSpace: 'nowrap' }}>157Global</span> exists. So the clients who need us, whether before a concern develops or in the middle of a crisis, get someone whose real world experience is the difference between theory and execution.
        </p>
        ...
        <blockquote className="my-10 border-l-[3px] border-accent pl-6 font-serif text-[20px] italic leading-[1.6] text-ink">
          <p>
            “I founded <span style={{ whiteSpace: 'nowrap' }}>157Global</span> because when real problems hit, the room gets loud, the clock speeds up, and pressure can corrupt decision-making. Many times, allies and friends disappear, creating a sense of aloneness.
          </p>
          <p className="mt-6">
